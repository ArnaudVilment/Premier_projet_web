...
public class CommandeDaoImpl implements CommandeDao {
	 ...
	 * entre une ligne issue de la table des commandes (un ResultSet) et un bean
	 * Commande.
	 */
	private Commande map(ResultSet resultSet) throws SQLException {
		...
		/*
		 * Petit changement ici : pour récupérer un client, il nous faut faire appel à
		 * la méthode trouver() du DAO Client, afin de récupérer un bean Client à partir
		 * de l'id présent dans la table Commande.
		 */
